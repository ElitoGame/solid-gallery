      ...
      <div
        ...
        style={{
          mask: merged.fadeBorders
            ? `linear-gradient(270deg, rgba(0,0,0,0) 0%, rgba(0,0,0,1) ${
                merged.fadeBordersPercent
              }%, rgba(0,0,0,1) ${100 - merged.fadeBordersPercent}%, rgba(0,0,0,0) 100%)`
            : "none",
        }}
      >
        <div
          class="glider__slides"
          style={{
            "padding-right": merged.elementGap,
            "column-gap": merged.elementGap,
            "animation-duration": `calc(${merged.animationSpeed} * 2)`,
            "animation-name":
              merged.animationDirection === "left-to-right" ? "glider_one" : "glider_one_reverse",
          }}
          ref={slides1}
        >
          {images()}
        ...
        <div
          class="glider__slides--dupe"
          style={{
            "padding-right": merged.elementGap,
            "column-gap": merged.elementGap,
            "animation-duration": `calc(${merged.animationSpeed} * 2)`,
            "animation-name":
              merged.animationDirection === "left-to-right" ? "glider_two" : "glider_two_reverse",
          }}
          ref={slides2}
        >
          {images2()}
